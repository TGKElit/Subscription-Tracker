  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      >
          ...
          <SafeAreaView style={{ paddingHorizontal: 12 }}>
            ...
            <View style={styles.infoBoxRow}>
              ...
              <Pressable style={styles.containerPrimary}>
                <Text style={styles.infoBoxTitle}>Pris</Text>
                <TextInput
            ...
            <Pressable style={styles.containerSecondary}>
              <Text style={styles.infoBoxTitle}>Beskrivning</Text>
              <TextInput
                style={styles.infoBoxInput}
                value={description}
                onChangeText={(text) =>
        ...
        {plan === "" && (
          <View id="billingPeriod" style={styles.billingPeriodContainer}>
            <Text
              style={{
                fontSize: 34,
        ...
        <View style={styles.deleteContainer}>
          <Text style={styles.deleteTitle}>Är du säker?</Text>
      ...
      <View id="presetPlan" style={styles.presetPlan}>
        {colorsPicture[name] && (
          <View
            style={[
          ...
          >
            <Image
              ...
              source={colorsPicture[name].picture}
            />
            <Text style={styles.presetPlanPictureTitle}>{name}</Text>
          </View>
        )}
        <View>
          <Text style={styles.presetPlanText}>Välj plan</Text>
          <View style={{ gap: 12 }}>
            {plans[name] && (
              <React.Fragment>
      ...
      <View id="date" style={styles.dateContainer}>
        <Text style={styles.dateTitle}>Startdatum</Text>
