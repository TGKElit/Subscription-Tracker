...
const StatisticsScreen = ({ navigation }) => {
  ...
  Object.keys(subscriptions).map((key) => {
    if (subscriptions[key].billingPeriod === "år") {
      ...
      quaterlyCosts += parseFloat(subscriptions[key].price)
    ...
    <SafeAreaView style={styles.body}>
      ...
      <ScrollView>
        <View style={styles.torso}>
          ...
          <View style={styles.box}>
            <Text style={styles.description}>Pris för dina kvartalsvisa prenumerationer</Text>
            <Text style={styles.cost}>
              {quaterlyCosts}kr <Text style={styles.period}>/kvartal</Text>
            </Text>
          </View>
